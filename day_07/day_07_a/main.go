...
func isFiveOfAKind(n map[int]int) bool {
	return len(n) == 1
}

func isFourOfAKind(n map[int]int) bool {
	for _, v := range n {
		if v == 4 {
			return true
		}
...
func isThreeOfAKind(n map[int]int) bool {
	for _, v := range n {
		if v == 3 {
			return true
		}
...
func isPair(n map[int]int) bool {
	for _, v := range n {
		if v == 2 {
			return true
		}
...
func isTwoPair(n map[int]int) bool {
	count := 0
	for _, v := range n {
		if v == 2 {
			count++
...
func isFullHouse(n map[int]int) bool {
	return len(n) == 2
}
